	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			...
			<section class="show-list col-wd-12 col-md-8 col-sm-8">
				<div class="col">
					<div class="show-list-title">NHÓM ${categoryParent.name }</div>
					<div class="show-list-content">
						<c:forEach var="cate" items="${categories }">
						<div class="col-wd-6 col-md-4 col-sm-4">
							<a href="${pageContext.request.contextPath }/product/${cate.cateId}/1/">
								<div class="col list-item">
									<div class="avatar">
										<img class="img-responsive" src="<c:url value='${cate.avatar }'/>" alt="avatar" />
									</div>
									<div class="desc">${cate.name }</div>
								</div>
							</a>
						</div>
						</c:forEach>
				...
				<div class="col">
						...
						<div class="content">
							<div class="box-image">
								<img class="img-responsive"
									src="<c:url value='/resources/images/advers/medium_4068_640x384.jpg'/>"
									alt="banner" />
							</div>
					...
					<div class="box-title col-wd-12 col-md-12 col-sm-12">
						...
						<div class="content">
							<div class="box-image">
								<img class="img-responsive"
									src="<c:url value='/resources/images/advers/medium_4120_anhbaiprweb.jpg'/>"
									alt="banner" />
							</div>
							<div class="box-desc">Pico tặng tiền cho khách hàng mua sắm
							</div>
					...
					<div class="box-non-title col-wd-12 col-md-12 col-sm-12">
						<div class="banner">
							<img class="img-responsive"
								src="<c:url value='/resources/images/advers/2047_banner_khai_truong_pico_tdt-01.jpg'/>"
								atl="banner" />
						</div>
					</div>
