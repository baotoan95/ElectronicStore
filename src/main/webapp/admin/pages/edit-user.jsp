...
<div class="form-group">
	<label for="name">Tên</label> <input type="text" class="form-control"
		id="name" name="name" value="${requestScope.user.name }">
</div>
<div class="form-group">
...
<div class="form-group">
	<label for="score">Điểm</label> <input type="text" class="form-control"
		id="score" name="score" value="${requestScope.user.score }">
</div>
<div class="form-group">
	<label for="registryDate">Ngày đăng ký</label> <input type="text"
		class="form-control" id="registryDate" name="registryDate"
		value="${requestScope.user.registryDate }">
</div>
<div class="form-group">
...
<button id="save"
	action='${(not empty requestScope.user) ? "save" : "add" }'
